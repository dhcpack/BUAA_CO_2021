...
xst -ifn xst.scr
move IP_CLOCK_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\IP_CLOCK_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc IP_CLOCK_exdes.ucf IP_CLOCK_exdes

echo 'Running map'
map -timing -pr b IP_CLOCK_exdes -o mapped.ncd
...
netgen -ofmt verilog -sim -sdf_anno false -tm IP_CLOCK_exdes -w routed.ncd routed.v
cd ..
