...
vlog -work work IP_CLOCK_tb.v

REM run the simulation
vsim -c -t ps +transport_int_delays -voptargs="+acc" -L secureip -L simprims_ver -sdfmax IP_CLOCK_tb\dut=..\..\implement\results\routed.sdf +no_notifier work.IP_CLOCK_tb work.glbl
