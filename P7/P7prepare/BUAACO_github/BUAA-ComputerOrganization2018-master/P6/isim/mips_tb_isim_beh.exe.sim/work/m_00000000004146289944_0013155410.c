...
#endif
static const char *ng0 = "D:/ise_project/P6new/Mpart.v";
...
LAB81:    t250 = *((unsigned int *)t174);
    t251 = (~(t250));
    t252 = *((unsigned int *)t200);
    t253 = (t251 || t252);
    if (t253 > 0)
        goto LAB82;
...
LAB87:    memcpy(t173, t254, 8);

LAB88:    goto LAB15;

LAB16:    xsi_vlog_unsigned_bit_combine(t3, 4, t33, 4, t173, 4);
    goto LAB20;
...
LAB53:    memcpy(t78, t123, 8);

LAB54:    goto LAB32;

LAB33:    xsi_vlog_unsigned_bit_combine(t33, 4, t73, 4, t78, 4);
    goto LAB37;
...
LAB70:    memcpy(t123, t168, 8);

LAB71:    goto LAB49;

LAB50:    xsi_vlog_unsigned_bit_combine(t78, 4, t118, 4, t123, 4);
    goto LAB54;

LAB52:    memcpy(t78, t118, 8);
    goto LAB54;
...
LAB67:    xsi_vlog_unsigned_bit_combine(t123, 4, t163, 4, t168, 4);
    goto LAB71;

LAB69:    memcpy(t123, t163, 8);
    goto LAB71;
...
LAB100:    if (*((unsigned int *)t240) > 0)
        goto LAB101;

LAB102:    if (*((unsigned int *)t205) > 0)
        goto LAB103;

LAB104:    memcpy(t204, t249, 8);
...
LAB117:    if (*((unsigned int *)t281) > 0)
        goto LAB118;

LAB119:    if (*((unsigned int *)t255) > 0)
        goto LAB120;

LAB121:    memcpy(t254, t290, 8);

LAB122:    goto LAB83;

LAB84:    xsi_vlog_unsigned_bit_combine(t173, 4, t204, 4, t254, 4);
    goto LAB88;

LAB86:    memcpy(t173, t204, 8);
    goto LAB88;
...
LAB101:    xsi_vlog_unsigned_bit_combine(t204, 4, t244, 4, t249, 4);
    goto LAB105;

LAB103:    memcpy(t204, t244, 8);
    goto LAB105;
...
LAB114:    t285 = ((char*)((ng8)));
    goto LAB115;

LAB116:    t290 = ((char*)((ng1)));
    goto LAB117;

LAB118:    xsi_vlog_unsigned_bit_combine(t254, 4, t285, 4, t290, 4);
    goto LAB122;

LAB120:    memcpy(t254, t285, 8);
    goto LAB122;
...
extern void work_m_00000000004146289944_0013155410_init()
{
	static char *pe[] = {(void *)Cont_43_0,(void *)Cont_44_1,(void *)Cont_45_2,(void *)Cont_46_3,(void *)Cont_61_4,(void *)implSig1_execute,(void *)implSig2_execute,(void *)implSig3_execute,(void *)implSig4_execute,(void *)implSig5_execute,(void *)implSig6_execute};
	xsi_register_didat("work_m_00000000004146289944_0013155410", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000004146289944_0013155410.didat");
