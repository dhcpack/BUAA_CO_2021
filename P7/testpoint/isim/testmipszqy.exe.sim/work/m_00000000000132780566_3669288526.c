...
LAB50:    t169 = (t0 + 6248);
    xsi_vlogvar_wait_assign_value(t169, t111, 0, 0, 32, 0LL);
    t2 = ((char*)((ng1)));
    t3 = (t0 + 6408);
...
LAB71:    if (*((unsigned int *)t159) > 0)
        goto LAB72;

LAB73:    if (*((unsigned int *)t151) > 0)
        goto LAB74;

LAB75:    memcpy(t150, t163, 8);

LAB76:    goto LAB58;

LAB59:    xsi_vlog_unsigned_bit_combine(t130, 32, t145, 32, t150, 32);
    goto LAB63;

LAB61:    memcpy(t130, t145, 8);
    goto LAB63;

LAB64:    *((unsigned int *)t151) = 1;
    goto LAB67;
...
LAB72:    xsi_vlog_unsigned_bit_combine(t150, 32, t164, 32, t163, 32);
    goto LAB76;

LAB74:    memcpy(t150, t164, 8);
    goto LAB76;
...
LAB98:    xsi_vlog_unsigned_bit_combine(t27, 32, t70, 32, t31, 32);
    goto LAB102;

LAB100:    memcpy(t27, t70, 8);
    goto LAB102;

}


extern void work_m_00000000000132780566_3669288526_init()
{
	static char *pe[] = {(void *)Cont_63_0,(void *)Always_64_1,(void *)Always_72_2};
	xsi_register_didat("work_m_00000000000132780566_3669288526", "isim/testmipszqy.exe.sim/work/m_00000000000132780566_3669288526.didat");
