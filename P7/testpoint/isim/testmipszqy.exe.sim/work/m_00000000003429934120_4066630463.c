...
LAB44:    if (*((unsigned int *)t23) > *((unsigned int *)t21))
        goto LAB42;
...
LAB56:    memcpy(t22, t60, 8);

LAB57:    t65 = (t0 + 4648);
    xsi_vlogvar_wait_assign_value(t65, t22, 0, 0, 32, 0LL);
    t2 = (t0 + 1688U);
    t3 = *((char **)t2);
    t2 = (t0 + 4808);
...
LAB49:    t52 = (t0 + 1528U);
    ...
    t52 = ((char*)((ng1)));
    memset(t61, 0, 8);
    xsi_vlog_unsigned_minus(t61, 32, t54, 32, t52, 32);
    goto LAB50;

LAB51:    t60 = ((char*)((ng2)));
    goto LAB52;

LAB53:    xsi_vlog_unsigned_bit_combine(t22, 32, t61, 32, t60, 32);
    goto LAB57;

LAB55:    memcpy(t22, t61, 8);
    goto LAB57;

}


extern void work_m_00000000003429934120_4066630463_init()
{
	static char *pe[] = {(void *)Initial_62_0,(void *)Always_83_1};
	xsi_register_didat("work_m_00000000003429934120_4066630463", "isim/testmipszqy.exe.sim/work/m_00000000003429934120_4066630463.didat");
