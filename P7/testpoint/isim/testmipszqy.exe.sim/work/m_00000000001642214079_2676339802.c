...
LAB63:    if (*((unsigned int *)t182) > 0)
        goto LAB64;

LAB65:    if (*((unsigned int *)t173) > 0)
        goto LAB66;

LAB67:    memcpy(t172, t191, 8);

LAB68:    t211 = (t0 + 2888);
    xsi_vlogvar_wait_assign_value(t211, t172, 0, 0, 32, 0LL);
    t2 = ((char*)((ng0)));
    t3 = (t0 + 3048);
...
LAB76:    if (*((unsigned int *)t201) > 0)
        goto LAB77;

LAB78:    if (*((unsigned int *)t192) > 0)
        goto LAB79;

LAB80:    memcpy(t191, t205, 8);

LAB81:    goto LAB63;

LAB64:    xsi_vlog_unsigned_bit_combine(t172, 32, t186, 32, t191, 32);
    goto LAB68;

LAB66:    memcpy(t172, t186, 8);
    goto LAB68;

LAB69:    *((unsigned int *)t192) = 1;
    goto LAB72;
...
LAB77:    xsi_vlog_unsigned_bit_combine(t191, 32, t206, 32, t205, 32);
    goto LAB81;

LAB79:    memcpy(t191, t206, 8);
    goto LAB81;
...
extern void work_m_00000000001642214079_2676339802_init()
{
	static char *pe[] = {(void *)Always_14_0};
	xsi_register_didat("work_m_00000000001642214079_2676339802", "isim/testmipszqy.exe.sim/work/m_00000000001642214079_2676339802.didat");
