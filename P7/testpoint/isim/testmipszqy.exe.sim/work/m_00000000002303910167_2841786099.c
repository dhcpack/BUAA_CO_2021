...
LAB31:    t2 = ((char*)((ng3)));
    t44 = xsi_vlog_unsigned_case_compare(t3, 4, t2, 32);
    if (t44 == 1)
        goto LAB32;
...
LAB45:    t4 = ((char*)((ng3)));
    ...
    t11 = (t0 + 2568);
    xsi_vlogvar_wait_assign_value(t11, t47, 32, 0, 32, 0LL);
    goto LAB44;
...
LAB46:    t4 = ((char*)((ng3)));
    ...
    t2 = (t0 + 1528U);
    t4 = *((char **)t2);
    xsi_vlogtype_zero_extend(t45, 64, t4, 32);
    t2 = (t0 + 1688U);
    t5 = *((char **)t2);
    xsi_vlogtype_zero_extend(t46, 64, t5, 32);
    xsi_vlog_unsigned_multiply(t47, 64, t45, 64, t46, 64);
    t2 = (t0 + 2728);
    xsi_vlogvar_wait_assign_value(t2, t47, 0, 0, 32, 0LL);
    t11 = (t0 + 2568);
    xsi_vlogvar_wait_assign_value(t11, t47, 32, 0, 32, 0LL);
...
LAB66:    t2 = (t0 + 1528U);
    ...
    t5 = *((char **)t2);
    memset(t48, 0, 8);
    xsi_vlog_unsigned_divide(t48, 32, t4, 32, t5, 32);
    t2 = (t0 + 2728);
    xsi_vlogvar_wait_assign_value(t2, t48, 0, 0, 32, 0LL);
    t2 = (t0 + 1528U);
    t4 = *((char **)t2);
    ...
    t5 = *((char **)t2);
    memset(t48, 0, 8);
    xsi_vlog_unsigned_mod(t48, 32, t4, 32, t5, 32);
    t2 = (t0 + 2568);
    xsi_vlogvar_wait_assign_value(t2, t48, 0, 0, 32, 0LL);
...
extern void work_m_00000000002303910167_2841786099_init()
{
	static char *pe[] = {(void *)Cont_29_0,(void *)NetDecl_33_1,(void *)Always_36_2};
	xsi_register_didat("work_m_00000000002303910167_2841786099", "isim/testmipszqy.exe.sim/work/m_00000000002303910167_2841786099.didat");
