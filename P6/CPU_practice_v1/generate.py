...
def gen(num):
    ...
    os.system(
        "java -jar mars2.jar " + num + "-mips.asm nc mc CompactDataAtZero a dump .text HexText code.txt")  # 导出Mars机器码
    os.system(
        "java -jar mars2.jar " + num + "-mips.asm db nc mc CompactDataAtZero> mipsoutput.txt")  # 导出Mars输出结果（初始数据地址为0，开启延迟槽）
    # os.system("java -jar mars2.jar testpoint" + num + ".asm nc mc CompactDataAtZero a dump .text HexText code.txt")
    # os.system("java -jar mars2.jar testpoint" + num + ".asm db nc mc CompactDataAtZero> " + num + "-ans.txt")
    # 生成仿真需要的两个文件
    ...
    # # 命令行运行ISim
    # os.system(
    #     r"D:\ISESetup\14.7\ISE_DS\ISE\bin\nt64\fuse --nodebug --prj testmine.prj -o testmipsmine.exe mips_tb >CompileLogmine.txt")
    #
    # os.system(
    #     r"D:\ISESetup\14.7\ISE_DS\ISE\bin\nt64\fuse --nodebug --prj testzqy.prj -o testmipszqy.exe mips_tb >CompileLogzqy.txt")
    #
