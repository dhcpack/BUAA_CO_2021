...
{
	int stk[10],tot=0;
	if (command[num].highSix==0 || command[num].highSix==28)
	{
...
inline void printhigh(bool notfinal)
{
	...
	for (int i=0;i<totnum;i++) if (command[i].highSix!=0 && command[i].highSix!=1 && command[i].highSix!=28) con++;
	for (int i=0;i<totnum;i++) if (command[i].highSix!=0 && command[i].highSix!=1 && command[i].highSix!=28)
	{
...
int main()
{
	...
	printstart(),printhigh(1),printlow(1),printmid(1),printdouble(0);
