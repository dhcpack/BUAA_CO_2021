...
#endif
static const char *ng0 = "E:/1-Project/CPU/ALU.v";
...
LAB20:    t333 = (t0 + 3936);
    ...
    t337 = *((char **)t336);
    memcpy(t337, t3, 8);
    xsi_driver_vfirst_trans(t333, 0, 31);
    t338 = (t0 + 3824);
    *((int *)t338) = 1;
...
LAB103:    if (*((unsigned int *)t253) > 0)
        goto LAB104;

LAB105:    if (*((unsigned int *)t228) > 0)
        goto LAB106;

LAB107:    memcpy(t227, t273, 8);

LAB108:    goto LAB86;

LAB87:    xsi_vlog_unsigned_bit_combine(t190, 32, t222, 32, t227, 32);
    goto LAB91;

LAB89:    memcpy(t190, t222, 8);
    goto LAB91;
...
LAB100:    t257 = (t0 + 1208U);
    ...
    *((unsigned int *)t257) = (t267 & 31U);
    memset(t268, 0, 8);
    xsi_vlog_unsigned_lshift(t268, 32, t258, 32, t259, 5);
    goto LAB101;

LAB102:    t275 = (t0 + 1368U);
    t276 = *((char **)t275);
    t275 = ((char*)((ng7)));
    memset(t277, 0, 8);
    t278 = (t276 + 4);
...
LAB110:    *((unsigned int *)t277) = 1;

LAB112:    memset(t274, 0, 8);
    t293 = (t277 + 4);
...
LAB120:    if (*((unsigned int *)t300) > 0)
        goto LAB121;

LAB122:    if (*((unsigned int *)t274) > 0)
        goto LAB123;

LAB124:    memcpy(t273, t332, 8);

LAB125:    goto LAB103;

LAB104:    xsi_vlog_unsigned_bit_combine(t227, 32, t268, 32, t273, 32);
    goto LAB108;

LAB106:    memcpy(t227, t268, 8);
    goto LAB108;
...
LAB117:    t307 = (t0 + 1048U);
    t308 = *((char **)t307);
    t307 = (t0 + 1208U);
    t310 = *((char **)t307);
    memset(t311, 0, 8);
    xsi_vlog_signed_less(t311, 32, t308, 32, t310, 32);
    memset(t305, 0, 8);
    t307 = (t311 + 4);
...
LAB133:    if (*((unsigned int *)t318) > 0)
        goto LAB134;

LAB135:    if (*((unsigned int *)t305) > 0)
        goto LAB136;

LAB137:    memcpy(t304, t327, 8);

LAB138:    goto LAB118;

LAB119:    t332 = ((char*)((ng8)));
    goto LAB120;

LAB121:    xsi_vlog_unsigned_bit_combine(t273, 32, t304, 32, t332, 32);
    goto LAB125;

LAB123:    memcpy(t273, t304, 8);
    goto LAB125;
...
LAB130:    t322 = ((char*)((ng2)));
    goto LAB131;

LAB132:    t327 = ((char*)((ng1)));
    goto LAB133;

LAB134:    xsi_vlog_unsigned_bit_combine(t304, 32, t322, 32, t327, 32);
    goto LAB138;

LAB136:    memcpy(t304, t322, 8);
    goto LAB138;
...
extern void work_m_00000000004115211720_0886308060_init()
{
	static char *pe[] = {(void *)Cont_12_0,(void *)Cont_21_1,(void *)Cont_22_2};
	xsi_register_didat("work_m_00000000004115211720_0886308060", "isim/mips_tb_isim_beh.exe.sim/work/m_00000000004115211720_0886308060.didat");
